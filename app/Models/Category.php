...
class Category extends Model
{
    ...
    public static function getCategory(){
        return Category::where('is_parent',1)->orderBy('title','ASC')->paginate(10);
    }
    ...
    public static function getAllParentWithChild(){
        return Category::with('child_cat')->where('is_parent',1)->where('parent_id',NULL)->where('status','active')->orderBy('title','ASC')->get();
    }
