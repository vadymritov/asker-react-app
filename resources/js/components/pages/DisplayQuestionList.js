  ...
  return (
    <Fragment>
      <div class="container ease-in-effect">
            ...
            >
              <ul>
                {PreBuiltQuestions.map((item) => (
                  <li onClick={() => selectQuestions(item.id)}>
        ...
        <Modal show={show} onHide={handleClose} dialogClassName="add-question">
          <Modal.Body>
                    ...
                    <div class="icon">
                      <img
                        src={
                          ...
                          "/images/create-asker-icon.png"
                        }
                      />
                    </div>
                    <div class="cont">
                      <p title={props.data.title} class="who-asking">
                        {props.data.title}
                      </p>
                      <h5 title={props.data.author} class="what-about">
                        {props.data.author}
                      </h5>
                    </div>
                  </div>
