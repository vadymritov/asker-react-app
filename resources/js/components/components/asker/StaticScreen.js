        ...
        <div className="static-main-section">
            <div class="static-tellme-inner">
                ...
                <div class="tellme-content" id="tellMeTilt">
                    <div
                        class="tellme-content-before-after"
                        id="tellMeTiltBeforeAfter"
                    >
                        <img alt="" className="before" src={tellmebefore} />
                        <img alt="" className="after" src={tellmeafter} />
                    </div>
                    <div class="text">
                        <h2>
                    ...
                    <div class="bttn">
                        {LoginStatus === true ? (
                            <Link to={"/Create_asker"}>Create Asker</Link>
                        ) : (
                            <Link to={"/LogIn"}>Create Asker</Link>
                        )}
                    </div>
                </div>

                <div class="tellme-download">
                    <a href="javascript:" class="app-store">
                        <img alt="" src={appstore} />
                    </a>

                    <a href="javascript:" class="google-play">
