      ...
      <div class="col-xl-10 col-lg-12 col-md-9 mt-5">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-6 d-none d-flex  justify-content-center align-items-center bg-login-image">
                <img src="{{asset("images/logo.svg")}}" alt="" style="width:65%">
              </div>
              <div class="col-lg-6">
                <div class="p-5">
