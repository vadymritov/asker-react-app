...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('country.store')}}" data-validate="true">
        {{csrf_field()}}
        ...
        <div class="form-group">
            ...
            <input id="inputSlug" type="text" name="code" placeholder="Enter Country Code"  value="{{old('code')}}" class="form-control" required >
            @error('code')
            <span class="text-danger">{{$message}}</span>
            @enderror
        </div>
