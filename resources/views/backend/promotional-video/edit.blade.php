...
@section('title','Edit Promotional Video')
@section('main-content')

<div class="card ca-card">
    <h5 class="card-header ca-card-header">Edit Banner</h5>
    <div class="card-body ca-card-body">
      <form method="post" action="{{route('video.update',$banner->id)}}" class="ca-form">
        @csrf 
        @method('PATCH')
