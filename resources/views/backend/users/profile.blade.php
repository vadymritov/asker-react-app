...
<div class="card shadow mb-4">
   ...
   <div class="card-header py-3">
     ...
     <ul class="breadcrumbs">
         <li><a href="{{route('admin')}}" id="dashboard">Dashboard</a></li>
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="image">
                        ...
                        @else 
                        <img class="card-img-top img-fluid roundend-circle mt-4" style="border-radius:50%;height:80px;width:80px;margin:auto;" src="{{asset('seller/img/avatar.png')}}" alt="profile picture">
                        @endif
                    </div>
