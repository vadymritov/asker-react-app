...
<div class="card ca-card">
    <h5 class="card-header ca-card-header">Add Questions</h5>
    <div class="card-body ca-card-body">
      <form method="post" action="{{route('question.store')}}" data-validate="true" class="ca-form">
        {{csrf_field()}}
        <div class="form-group ca-form-group ca-textfilled">
          ...
          <input id="inputTitle" type="text" name="question" placeholder="Enter Questions"  value="{{old('question')}}" class="form-control" required>
          @error('question')
