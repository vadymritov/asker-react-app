      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; <a href="https://www.coretus.com/" target="_blank">Coretus Technologies</a> {{date('Y')}}</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
  ...
  <a class="scroll-to-top rounded ca-scroll-top" href="#page-top">
